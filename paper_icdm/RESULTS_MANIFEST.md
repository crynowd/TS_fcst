...
Generated table CSV files are stored in `paper_icdm/tables/`. The Excel report `artifacts/reports/forecasting_audit_v2/meta_modeling_experiments_v2.xlsx` is retained as the exact Table VI source. No paper-specific figure outputs are created in this stage; figure builder scripts remain out of scope.
