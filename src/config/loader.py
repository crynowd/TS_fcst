...
def load_meta_modeling_experiments_config(config_path: str) -> Dict[str, Any]:
    ...
    defaults = {
        ...
        "per_class_metrics_csv_path": meta_dir / "per_class_metrics_experiments_v1.csv",
        "confusion_matrix_csv_path": meta_dir / "confusion_matrix_experiments_v1.csv",
        "class_distribution_csv_path": meta_dir / "class_distribution_experiments_v1.csv",
        "confidence_summary_csv_path": meta_dir / "confidence_summary_experiments_v1.csv",
        "selected_features_csv_path": meta_dir / "selected_features_experiments_v1.csv",
        "candidate_filtering_summary_csv_path": meta_dir / "candidate_filtering_summary_experiments_v1.csv",
        "feature_regime_summary_csv_path": meta_dir / "feature_regime_summary_experiments_v1.csv",
        "best_config_per_task_csv_path": meta_dir / "best_config_per_task_experiments_v1.csv",
    ...
    merged: Dict[str, Any] = {
        ...
        "target_metrics": stage_cfg.get("target_metrics", ["rmse", "directional_accuracy"]),
        "metric_columns": stage_cfg.get("metric_columns", {}),
        "methods": stage_cfg.get("methods", ["classification"]),
        "meta_models": stage_cfg.get("meta_models", ["ridge", "random_forest", "catboost"]),
