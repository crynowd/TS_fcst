...
SPLIT_METADATA_COLUMNS = [
    ...
    "outer_train_last_forecast_origin_idx",
    "outer_train_first_target_start_idx",
    "outer_train_last_target_start_idx",
    "outer_train_first_target_end_idx",
    ...
    "fit_last_forecast_origin_idx",
    "fit_first_target_start_idx",
    "fit_last_target_start_idx",
    "fit_first_target_end_idx",
    "fit_last_target_end_idx",
    "fit_n_samples_before_purge",
    "fit_n_samples_after_purge",
    "fit_n_samples_removed",
    "validation_first_forecast_origin_idx",
    "validation_last_forecast_origin_idx",
    "validation_first_target_start_idx",
    "validation_last_target_start_idx",
    "validation_first_target_end_idx",
    "validation_last_target_end_idx",
    "validation_n_samples_before_purge",
    "validation_n_samples_after_purge",
    "validation_n_samples_removed",
    "test_first_forecast_origin_idx",
    "test_last_forecast_origin_idx",
    "test_first_target_start_idx",
    "test_last_target_start_idx",
    "test_first_target_end_idx",
    "test_last_target_end_idx",
    "test_n_samples_before_purge",
    "test_n_samples_after_purge",
